...
public class ExpiredPromotionDetail extends AppCompatActivity {
       ...
       /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(ExpiredPromotionDetail.this, R.style.AlertDialogCustom));
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        pDialog = new ProgressDialog(ExpiredPromotionDetail.this);
                        ...
                        mCollectionReference.document(promotionId).delete()
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(ExpiredPromotionDetail.this, "Promotion successfully deleted",Toast.LENGTH_SHORT).show();
                                        pDialog.dismiss();
                                        finish();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ExpiredPromotionDetail.this, "Promotion deletion unsuccessful",Toast.LENGTH_SHORT).show();
                                    }
                                });
