...
public class PromotionFragment extends Fragment {
    ...
    public void show(){
        ...
        mCollectionReference.whereEqualTo("status","Ongoing").orderBy("startDate", Query.Direction.ASCENDING).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.history_btn:
                Intent intent = new Intent(getActivity(),ExpiredPromotion.class);
                startActivity(intent);
                return true;
